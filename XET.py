...
def goodbye():
	...
	print (Fore.RED+"Also, if you like my job consider a donation for me so i could keep focusing on X.E.T and keep my servers working!\nhttps://www.paypal.me/Mezutelni \n"+Fore.RESET)
	time.sleep(7)
	sys.exit()
def mix2Cam():
	os.system("adb shell mount /system")
	print (Fore.YELLOW+"Don't worry if you see error here^ this means that your system is mounted already"+Fore.RESET)
	...
	if isf == False:
		print (Fore.YELLOW+"I need to download camera file first, be patient please"+Fore.RESET)
		urllib.request.urlretrieve('http://80.211.242.62/cam.apk', resPath+'cam.apk')
	elif isf == True:
		print (Fore.GREEN+"Ok, you have camera file already!"+Fore.RESET)
...
def comMiuiHome():
	...
	if isf == False:
		print (Fore.YELLOW+"I need to download custom home file first, be patient please"+Fore.RESET)
		urllib.request.urlretrieve('http://80.211.242.62/home.file', resPath+'com.miui.home')
	elif isf == True:
		print (Fore.GREEN+"Ok, you have custom home file already!"+Fore.RESET)
...
def sideloader():
    while(True):
        print(Fore.YELLOW+"Due to problems with adb sideload implementation, you have to start sideload on your phone manually!"+Fore.RESET)
        ...
        if ifContinue == 'n':
            print(Fore.GREEN+"Ok, we'll go back now"+Fore.RESET)
            input("Push enter to continue")
            menu()
        elif ifContinue =="y":
            print(Fore.GREEN+"Ok! so here we go again"+Fore.RESET)
        else:
...
def twrpInstall():
    ...
    os.system('fastboot boot twrp.img')
    print (Fore.GREEN+"Please wait, +- 10s"+Fore.RESET)
    time.sleep(10)
...
def rbMenu():
	...
	print (Fore.YELLOW+"|Reboot to recovery using ADB (so make sure to turn on debugging)  |"+Fore.RESET)
	print (Fore.CYAN+"--------------------------------------------------------------------")
	print (Fore.CYAN+"|2. Reboot to fastboot                                             |")
	print (Fore.YELLOW+"|Reboot to fastboot using ADB (so make sure to turn on debugging)  |"+Fore.RESET)
	print (Fore.CYAN+"--------------------------------------------------------------------")
	print (Fore.CYAN+"|3. Reboot to system                                               |")
	print (Fore.YELLOW+"|Reboot to system using ADB (so make sure to turn on debugging)    |"+Fore.RESET)
	print (Fore.CYAN+"--------------------------------------------------------------------")
	print (Fore.CYAN+"|4. Reboot to system                                               |")
	print (Fore.YELLOW+"|Reboot to system using Fastboot mode!                             |"+Fore.RESET)
	print (Fore.CYAN+"--------------------------------------------------------------------")
	print (Fore.CYAN+"|5. Reboot to adb-sideload                                         |")
	print (Fore.YELLOW+"|Reboot to sideload using ADB-root (so use it when in recovery)    |"+Fore.RESET)
	print (Fore.CYAN+"--------------------------------------------------------------------")
...
def sTweaksMenu():
	...
	print (Fore.YELLOW+"|Use it to backup your build.prop file!                            |"+Fore.RESET)
	print (Fore.CYAN+"--------------------------------------------------------------------")
	print (Fore.CYAN+"|2. Build.prop restore                                             |")
	print (Fore.YELLOW+"|Use it to restore your build.prop file!                           |"+Fore.RESET)
	print (Fore.CYAN+"--------------------------------------------------------------------")
	print (Fore.CYAN+"|3. Change DPI                                                     |")
	print (Fore.YELLOW+"|For changing dpi more than once, you have to restore build.prop!  |"+Fore.RESET)
	print (Fore.CYAN+"--------------------------------------------------------------------")
	print (Fore.CYAN+"|4. Install mix 2 camera                                           |")
	print (Fore.YELLOW+"|Mix 2 camera ported for all Xiaomi devices;Tested only on miui9   |"+Fore.RESET)
	print (Fore.CYAN+"--------------------------------------------------------------------")
	print (Fore.CYAN+"|5. Install modified com.miui.home (desktop grid up to 10x10)      |")
	print (Fore.YELLOW+"|Miui 9 exclusive                                                  |"+Fore.RESET)
	print (Fore.CYAN+"--------------------------------------------------------------------")
	print (Fore.CYAN+"|6. Activate Camera 2 API                                          |")
	print (Fore.YELLOW+"|Use it to activate cam2api in your build.prop                     |"+Fore.RESET)
	print (Fore.CYAN+"--------------------------------------------------------------------")
	print (Fore.CYAN+"|0. Back to main menu                                              |")
	print (Fore.CYAN+"--------------------------------------------------------------------"+Fore.RESET)
	case = int(input(Fore.BLUE+"choose: "+Fore.RESET))
	if case == 1:
		...
		print (Fore.GREEN+"Backup complete! Your build.prop is now in res folder!"+Fore.RESET)
		os.system("adb shell umount /system")
		input("push enter to continue")
		sTweaksMenu()
	elif case == 2:
		...
		os.system('adb shell "chmod 644 /system/build.prop"')
		print (Fore.GREEN+"Restore complete!"+Fore.RESET)
		os.system("adb shell umount /system")
		input("push enter to continue")
		sTweaksMenu()
	elif case == 3:
...
def menu():
	clear()
	print (Style.BRIGHT+Fore.YELLOW+deviceN)
	print (Fore.GREEN+"--------------------------------------------------------------------")
	print ("| X.E.T                                                            |")
	print ("| Xiaomi Essential Tools                                           |")
	print ("--------------------------------------------------------------------"+Fore.RESET)
	print (Fore.CYAN+"|1. Reboot menu                                                    |")
	print (Fore.YELLOW+"|Simple reboot menu, to make your life more comfortable!           |"+Fore.RESET)
	print (Fore.CYAN+"--------------------------------------------------------------------")
	print (Fore.CYAN+"|2. System tweaks                                                  |")
	print (Fore.YELLOW+"|Here you can find system tweaks, they are all applied in recovery!|"+Fore.RESET)
	print (Fore.CYAN+"--------------------------------------------------------------------")
	print (Fore.CYAN+"|3. Install Recovery                                               |")
	print (Fore.YELLOW+"|Use it to install recovery                                        |"+Fore.RESET)
	print (Fore.CYAN+"--------------------------------------------------------------------")
	print (Fore.CYAN+"|4. Check bootloader status (locked/unlocked)                      |")
	print (Fore.YELLOW+"|You have to be in fastboot mode to make it work                   |"+Fore.RESET)
	print (Fore.CYAN+"--------------------------------------------------------------------")
	print (Fore.CYAN+"|5. ADB sideloader                                                 |")
	print (Fore.YELLOW+"|Start in recovery, then use it to flash all zips you want!        |"+Fore.RESET)
	print (Fore.CYAN+"--------------------------------------------------------------------")
